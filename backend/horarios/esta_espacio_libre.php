...
require_once dirname(__FILE__).'/../util/espacios.php'; // funciones relacionadas con profesores

if($_SERVER['REQUEST_METHOD'] == 'GET')
{
    $idEspacio = $_GET['id_espacio'];
    $nombreDia = $_GET['nombre_dia'];
    $numeroIntervalo = $_GET['numero_intervalo'];

    if(!isset($idEspacio)) Respuestas::enviarError('INDIQUE_ID_ESPACIO');
    ...
    $con = connectDb();
    Respuestas::enviarOk(espacioEstaLibreParaAsignacionHorario($con, $idEspacio, $idDia, $numeroIntervalo));
}
?>
